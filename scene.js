...
function main(){
  ...
  init3DObjects(sceneThreeJs.camera,sceneThreeJs.sceneGraph, drawingData,pickingDataPattes);  
  ...
  ///////////// Mouse Events ////////////////////////////////////////////////////////////
  const wrapperMouseDown = function(event) { mouseEvents.onMouseDown(event,sceneThreeJs.sceneGraph, sceneThreeJs.camera, raycaster, screenSize, drawingData, pickingDataPattes,Minus); };
  document.addEventListener( 'mousedown', wrapperMouseDown );
 
  const wrapperMouseMove = function(event) { mouseEvents.onMouseMove(event, sceneThreeJs.sceneGraph, sceneThreeJs.camera, raycaster, screenSize, drawingData, pickingDataPattes,Minus) };
  document.addEventListener( 'mousemove', wrapperMouseMove );

  const wrapperMouseUp = function(event) { mouseEvents.onMouseUp(event,sceneThreeJs.sceneGraph, sceneThreeJs.camera, raycaster, screenSize, drawingData, pickingDataPattes,Minus); };
...
function init3DObjects(camera,sceneGraph, drawingData,pickingDataPattes) {
  ...
  embryonPatte(sceneGraph,pickingDataPattes);
